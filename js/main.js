...
(function ($) {
	...
	Site = {
		...
		init: function (elt) {
			...
			// match heigh from tablet
			$('.yellow-list li').matchHeight();			
		},
		/**
		 * Accordion
		 *
		...
		videoEmbedOnClick: function(){
			...
			$('.videoCTA').on('click', function(e){
				...
				$videoContainer.find('.videoWrapper').html('<iframe width="580" height="327" src="'+urlToPlay+'" frameborder="0" allowfullscreen></iframe>').show();
				videoIsPlaying = true;
			});
